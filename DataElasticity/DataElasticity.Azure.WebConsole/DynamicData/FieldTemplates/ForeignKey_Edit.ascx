<%@ Control Language="C#" CodeBehind="ForeignKey_Edit.ascx.cs" Inherits="Microsoft.AzureCat.Patterns.DataElasticity.Azure.WebConsole.DynamicData.FieldTemplates.ForeignKey_EditField" %>
