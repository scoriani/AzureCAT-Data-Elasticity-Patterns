<%@ Control Language="C#" CodeBehind="Enumeration_Edit.ascx.cs" Inherits="Microsoft.AzureCat.Patterns.DataElasticity.Azure.WebConsole.DynamicData.FieldTemplates.Enumeration_EditField" %>
