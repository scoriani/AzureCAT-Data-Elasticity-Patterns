<%@ Control Language="C#" CodeBehind="Default_Edit.ascx.cs" Inherits="Microsoft.AzureCat.Patterns.DataElasticity.Azure.WebConsole.DynamicData.EntityTemplates.Default_EditEntityTemplate" %>
