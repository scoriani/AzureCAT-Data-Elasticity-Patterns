<%@ Control Language="C#" CodeBehind="Default_Insert.ascx.cs" Inherits="Microsoft.AzureCat.Patterns.DataElasticity.Azure.WebConsole.DynamicData.EntityTemplates.Default_InsertEntityTemplate" %>
