<%@ Page MasterPageFile="~/Site.Master" Language="C#" AutoEventWireup="true" CodeBehind="PrepareForTenantMoveQueue.aspx.cs" Inherits="Microsoft.AzureCat.Patterns.DataElasticity.Azure.WebConsole.Queues.PrepareForTenantMoveQueue" %>
    ...
    <asp:Repeater runat="server" ID="queueList">
        ...
        <ItemTemplate>
            <li>Status: <%#Eval("Status") %><br />
                ...
                Destination ServerInstanceName: <%#Eval("DestinationServerInstanceName") %><br />
                Destination Catalog: <%#Eval("DestinationCatalog") %><br />
            </li>
        </ItemTemplate>
        <FooterTemplate>
        </ul>
